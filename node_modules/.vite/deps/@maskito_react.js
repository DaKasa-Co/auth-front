...
var useMaskito = ({
  ...
  const [hostElement, setHostElement] = (0, import_react.useState)(null);
  const [element, setElement] = (0, import_react.useState)(null);
  const onRefChange = (0, import_react.useCallback)((node) => {
    setHostElement(node);
  }, []);
  const latestPredicateRef = (0, import_react.useRef)(elementPredicate);
...
//# sourceMappingURL=@maskito_react.js.map
